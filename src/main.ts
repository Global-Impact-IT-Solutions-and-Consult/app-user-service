...
async function bootstrap() {
  ...
  const config = new DocumentBuilder()
    ...
    .setDescription('User authentication and business management service with MFA, company onboarding, API keys, webhooks, receipts, Zoho Books and QuickBooks Online integration, and logging')
    .setVersion('1.0')
    .addBearerAuth(
      {
        type: 'http',
    ...
    .addTag('invoices', 'Stored invoices and NRS e-invoicing clearance')
  ...
  console.log(`Swagger documentation available at: http://localhost:${port}/${globalPrefix}/docs`);
}
bootstrap();
